...
From the main page, I was able to download the raw data both as a JSON and CSV file. You can find the raw data on GitHub in the file titled "EEA Raw Data.csv"
